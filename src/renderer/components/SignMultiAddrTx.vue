<template>
    <div>
        ...
        <div>
            ...
            <form @submit.prevent="">
                    <div class="form-group">
                        ...
                        <textarea name="" id="" wrap="virtual" v-model="txData" @change="deserializeTx" class="txDataText form-control"></textarea>
                    </div>
                    <div class="form-group">
        ...
        <div class="createSuccess" >
            ...
            data-clipboard-target="#signedTx"> <i class="fa fa-copy"></i> Copy</button>
